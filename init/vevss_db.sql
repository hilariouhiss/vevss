...
ALTER TABLE t_user ADD CONSTRAINT check_user_subject CHECK (subject = 0 OR subject = 1);
...
ALTER TABLE t_score_line ADD CONSTRAINT check_subject CHECK (subject = 0 OR subject = 1);
ALTER TABLE t_score_line ADD CONSTRAINT chk_total_score CHECK (total_score BETWEEN 0 AND 750);
ALTER TABLE t_score_line ADD CONSTRAINT chk_chinese CHECK (chinese BETWEEN 0 AND 150);
ALTER TABLE t_score_line ADD CONSTRAINT chk_math CHECK (math BETWEEN 0 AND 150);
ALTER TABLE t_score_line ADD CONSTRAINT chk_comprehensive CHECK (comprehensive BETWEEN 0 AND 300);
